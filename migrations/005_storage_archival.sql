...
COMMENT ON TABLE archival_logs IS 'Log of data archival operations for audit trail';
...
COMMENT ON COLUMN archival_logs.storage_path IS 'Path to the archived file in storage';
...
-- View: Archival history by table
